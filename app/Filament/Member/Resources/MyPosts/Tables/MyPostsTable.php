...
namespace App\Filament\Member\Resources\MyPosts\Tables;
...
class MyPostsTable
{
    public static function configure(Table $table): Table
    {
        ...
        ])->defaultSort('updated_at', 'desc')->filters([SelectFilter::make('review_status')->label('Trạng thái')->options(Post::REVIEW_STATUSES)])->recordActions([EditAction::make()->label('Chỉnh sửa / gửi lại')]);
    }
}
