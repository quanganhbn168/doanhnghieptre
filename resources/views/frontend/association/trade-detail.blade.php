    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="dnt-trade-detail">
            ...
            <aside class="dnt-trade-detail__contact">
                ...
                <p><strong>Nhu cầu</strong>{{ $tradePost->typeLabel($tradePost->type) }}</p>
        ...
        <a class="dnt-text-link" href="{{ route('trade.index') }}">← Quay lại chợ doanh nghiệp</a>
    </div>
</section>
@endsection
