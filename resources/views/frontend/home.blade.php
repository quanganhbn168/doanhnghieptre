                    ...
                    <div class="dnt-trade-list">
                        @foreach($tradePosts as $tradePost)
                            <article class="dnt-trade-list__item">
                                <span class="dnt-trade-list__icon"><i class="fa-solid {{ $tradePost->type === 'sell' ? 'fa-cart-shopping' : ($tradePost->type === 'collaborate' ? 'fa-handshake' : 'fa-magnifying-glass') }}" aria-hidden="true"></i></span>
